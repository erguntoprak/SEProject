...
namespace SE.Business.EducationServices
{
    public interface IEducationService
    {
        ...
        Task<IResult> DeleteEducationAsync(int educationId);
        ...
        Task<IDataResult<IEnumerable<EducationContactFormListDto>>> GetEducationContactFormListDtoBySeoUrlAsync(string seoUrl);
